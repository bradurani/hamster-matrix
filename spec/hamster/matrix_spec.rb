...
describe Hamster::Matrix::Matrix do
  ...
  context '#==' do
    context 'true cases' do
      it 'returns true if it compares to matrices with the same values' do
        matrix1 = Hamster::Matrix::Matrix.new([[1,1],[1,1]])
        matrix2 = Hamster::Matrix::Matrix.new([[1,1],[1,1]])
        expect(matrix1 == matrix2).to be true
      end

      it 'returns true if it compares to matrices with varying values' do
        matrix1 = Hamster::Matrix::Matrix.new([[1,2],[3,4]])
        matrix2 = Hamster::Matrix::Matrix.new([[1,2],[3,4]])
        expect(matrix1 == matrix2).to be true
      end

      it 'returns true if it compares two zero matrices' do
        matrix1 = Hamster::Matrix::Matrix.new([])
        matrix2 = Hamster::Matrix::Matrix.new([])
        expect(matrix1 == matrix2).to be true
      end

      it 'returns true if it compares equal non-sqaure matrices' do
        matrix1 = Hamster::Matrix::Matrix.new([[1,2,3],[3,4,5]])
        matrix2 = Hamster::Matrix::Matrix.new([[1,2,3],[3,4,5]])
        expect(matrix1 == matrix2).to be true
      end

      it 'returns true if it compares row matrices' do
        matrix1 = Hamster::Matrix::Matrix.new([[1,2,3]])
        matrix2 = Hamster::Matrix::Matrix.new([[1,2,3]])
        expect(matrix1 == matrix2).to be true
      end
      ...
      it 'returns true if it compares matrices of any type' do
        matrix1 = Hamster::Matrix::Matrix.new([[1],['s'],[:foo]])
        matrix2 = Hamster::Matrix::Matrix.new([[1],['s'],[:foo]])
        expect(matrix1 == matrix2).to be true
      end
    end
  ...
  context '#new' do
    it 'creates a matrix given an Array' do
      ...
      expected = Hamster::Matrix::Matrix.new([[1,1],[1,1]])
